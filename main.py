...
main = tkinter.Tk()
main.title("Customer retention strategies in e-commerce: Insights from purchasing intention data") 
...
def Prediction():
    ...
    for i in range(len(test)):
        ...
        if predict == 0:
            predicted_data = "Not Retained"
        elif predict == 1:
            predicted_data = "Retained"
...
def graph():
    # Create a DataFrame
    df = pd.DataFrame([
    ['ETC', 'Precision', precision[0]],
    ['ETC', 'Recall', recall[0]],
    ['ETC', 'F1 Score', fscore[0]],
    ['ETC', 'Accuracy', accuracy[0]],
...
font = ('times', 16, 'bold')
title = Label(main, text='Customer retention strategies in e-commerce: Insights from purchasing intention data', justify=LEFT)
